 ...
 const {isPending,error ,loginMutation}=useLogin()
  ...
  return (
    <div className='h-screen flex items-center justify-center p-4 sm:p-6 md:p-8' data-theme="night"> 
        <div className='border border-primary/25 flex flex-col lg:flex-row w-full max-w-5xl mx-auto bg-base-100 rouded-xl shadow-lg overflow-hidden'>
        {/* Login Form Section  */}
                   ...
                   <form  onSubmit={handleLogin}>
                     <div className='space-y-4'> 
                        ...
                        <div className='flex flex-col gap-3'>
                          ...
                          <button type='submit' className='btn btn-primary w-full' disabled={isPending}>{isPending?(
                            <>
